...
![How text becomes tokens](./assets/tokens.svg)
...
![Embeddings: meaning becomes geometry](./assets/embeddings.svg)
...
![The six axes of AI problem complexity](./assets/complexity-axes.svg)
...
![Copilot Studio vs custom architecture](./assets/architecture-comparison.svg)
...
![Decision flowchart: Copilot Studio vs MCP vs Custom](./assets/decision-flowchart.svg)
